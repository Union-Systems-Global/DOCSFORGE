...
const navItems = [
  ...
  { title: "Client Setup", url: "/setup", icon: Settings },
];
      ...
      <div className={cn("flex items-center h-14 border-b border-border px-4", collapsed && "justify-center px-2")}>
        {!collapsed && (
          <div className="flex items-center gap-2 flex-1">
            ...
            <span className="font-semibold text-sm tracking-tight text-primary">DocsForge</span>
          </div>
        )}
        <button
      ...
      {!collapsed && (
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center text-xs font-semibold text-primary uppercase">
              DF
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate">DocsForge Admin</p>
              <p className="text-xs text-muted-foreground truncate">Documentation Team</p>
            </div>
          </div>
        </div>
      )}
